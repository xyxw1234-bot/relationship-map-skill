...
required=[
 ...
 'relationship-map/scripts/relationship_runtime.py','relationship-map/scripts/relationship_store.py','relationship-map/scripts/relationship_view_adapter.py','relationship-map/scripts/run_storage_view_e2e_tests.py','relationship-map/scripts/run_v25_acceptance.py',
]
for rel in required:
